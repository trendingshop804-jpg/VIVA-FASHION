...
export const AdditionalCustomerLove: React.FC = () => {
  ...
  return (
    <section className="w-full bg-[#FAF7F2] py-8 md:py-10 border-b border-[#EAE3D9]/60">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          
          {/* Left Column: 3 Photos - 7 cols */}
          <div className="md:col-span-7 space-y-3">
            ...
            <div className="grid grid-cols-3 gap-2.5 sm:gap-3.5">
              {CUSTOMER_REVIEWS_ROW1.map((item) => (
                <div
                  key={`add-${item.id}`}
          ...
          {/* Right Column: Editorial story (5 cols) */}
          <div className="md:col-span-5 space-y-3 md:pl-4">
            ...
            <p className="text-xs text-[#555E6C] leading-relaxed">
              We believe in sustainable slow fashion. Each design in our ethnic collection undergoes rigorous fabric testing to ensure zero shrinkage, vibrant colorfastness, and seamless drape through countless summer days.
            </p>
